<form action="{{route('servicios.edit',$servicios->id)}}" id="userForm" method="GET" enctype="multipart/form-data">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <table align="center" width="95%" cellpadding="4" cellspacing="0">
          <tr align="center">
            <td width="5%" class=""> 
              <a type="button" id="userResetSearchBtn" href="{{route('servicios.edit',$servicios->id)}}" class="btn btn-secondary">Borrar Filtros</a>
            </td>
            <td width="18%" class=""> 
